...
void NeZha_Reset()
{
	...
	NeZha_I2C_SendByte(NEZHA_CMD_RESET);
	NeZha_I2C_Stop();
	NeZha_Delay_ms(500);	//延时等待从机复位，改延时不可去掉!!!
}
...
/**
  ...
  * @retval 无
  */
void NeZha_Motor1_SetPwm(unsigned int motor_a,unsigned int motor_b)
{
	unsigned char motor_ah,motor_al,motor_bh,motor_bl;

	motor_ah = (unsigned char)(motor_a >> 8);
	motor_al = (unsigned char)(motor_a & 0x00FF);
	motor_bh = (unsigned char)(motor_b >> 8);
	motor_bl = (unsigned char)(motor_b & 0x00FF);
...
/**
  ...
  * @retval 无
  */
void NeZha_Motor2_SetPwm(unsigned int motor_a,unsigned int motor_b)
{
	unsigned char motor_ah,motor_al,motor_bh,motor_bl;
...
/**
  ...
  * @retval 无
  */
void NeZha_Motor3_SetPwm(unsigned int motor_a,unsigned int motor_b)
{
	unsigned char motor_ah,motor_al,motor_bh,motor_bl;
...
/**
  ...
  * @retval 无
  */
void NeZha_Motor4_SetPwm(unsigned int motor_a,unsigned int motor_b)
{
	unsigned char motor_ah,motor_al,motor_bh,motor_bl;
...
/**
  ...
  * @retval 无
  */
void NeZha_Servo1_SetPwm(unsigned int pwm)
{
	unsigned char servo1_h,servo1_l;

	servo1_h = (unsigned char)(pwm >> 8);
	servo1_l = (unsigned char)(pwm & 0x00FF);
...
/**
  ...
  * @retval 无
  */
void NeZha_Servo2_SetPwm(unsigned int pwm)
{
	unsigned char servo2_h,servo2_l;

	servo2_h = (unsigned char)(pwm >> 8);
	servo2_l = (unsigned char)(pwm & 0x00FF);
...
/**
  ...
  * @retval 无
  */
void NeZha_Servo3_SetPwm(unsigned int pwm)
{
	unsigned char servo3_h,servo3_l;

	servo3_h = (unsigned char)(pwm >> 8);
	servo3_l = (unsigned char)(pwm & 0x00FF);
...
/**
  ...
  * @retval 无
  */
void NeZha_Servo4_SetPwm(unsigned int pwm)
{
	unsigned char servo4_h,servo4_l;

	servo4_h = (unsigned char)(pwm >> 8);
	servo4_l = (unsigned char)(pwm & 0x00FF);
...
/**
  ...
  * @retval 无
  */
void NeZha_WriteCommand(unsigned char Command)
{
	NeZha_I2C_Start();
	NeZha_I2C_SendByte(NEZHA_ADDR);
