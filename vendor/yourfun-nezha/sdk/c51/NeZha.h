...
void NeZha_Forward(unsigned int Speed);
void NeZha_Backward(unsigned int Speed);
void NeZha_TurnLeft(unsigned int Speed);
void NeZha_TurnRight(unsigned int Speed);
void NeZha_TransLeft(unsigned int Speed);
void NeZha_TransRight(unsigned int Speed);
...
int NeZha_Encoder1_Read(void);
int NeZha_Encoder2_Read(void);
int NeZha_Encoder3_Read(void);
int NeZha_Encoder4_Read(void);
